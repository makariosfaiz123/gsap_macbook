...
Files: macbook.glb [629.72KB] > D:\Projects\macbook\public\models\macbook-transformed.glb [627.9KB] (0%)
...
export default function MacBookModel(props) {
  const {color,textrue} = useMacBookStore();
  const { nodes, materials,scene } = useGLTF('/models/macbook-transformed.glb')

  const screen = useVideoTexture(textrue);
